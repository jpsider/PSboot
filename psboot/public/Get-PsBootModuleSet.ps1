function Get-PSbootModuleSet
{
    ...
    if ($pscmdlet.ShouldProcess("Starting Get-PSbootModuleSet function."))
    {
        try
        {
            $URI = "http://$PSbootServer/PSboot/api/index.php/modules?transform=true"
