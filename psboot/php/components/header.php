    ...
    <div class="main-container">
        <header class="header header-3">
            ...
            <div class="header-actions">
                <div class="btn-group">
                    <button class="btn btn-inverse btn-sm" type="button" onclick="switch_style('dark');return false;"
                        name="theme" value="Dark Theme" id="dark">Dark Theme</button>
                    <button class="btn btn-inverse btn-sm" type="button" onclick="switch_style('light');return false;"
                        name="theme" value="Light Theme" id="light">Light Theme</button>
                </div>
                <div class="toggle-switch">
                    <input type="checkbox" id="reloadCB" onclick="toggleAutoRefresh(this);">
                    <label for="reloadCB">Refresh</label>
                </div>
                <a href="https://github.com/jpsider/psboot" class="nav-link nav-icon" target="_blank">
